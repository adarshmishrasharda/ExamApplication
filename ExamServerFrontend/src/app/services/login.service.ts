...
export class LoginService {
  ...
  public generateOtp(forgot:any)
  {

    return this.httpclient.post(`${baseUrl}/user/forgot-password`,forgot);

  }
  public verifyOtp(forgot:any)
  {

    return this.httpclient.post(`${baseUrl}/user/verify-otp`,forgot);

  }

  public changePassword(changedata:any)
  {
     return this.httpclient.post(`${baseUrl}/user/change-password`,changedata)
  }
